                                            ...
                                            <td key={field} className="p-2">
                                                <div className="relative">
                                                    <input
                                                        ...
                                                        disabled={disabled}
                                                        className={`w-full px-3 py-2 border border-slate-300 rounded-md shadow-sm placeholder-slate-400 focus:ring-2 focus:ring-blue-200 focus:border-blue-500 focus:outline-none transition ${isNumberField ? 'text-right' : ''} ${fieldHistory.length > 0 ? 'pr-10' : ''} disabled:bg-slate-100 disabled:cursor-not-allowed`}
                                                    />
