...
export default function SuspensionOfClassesForm({ data, setData, errors, disabled = false }) {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            toast.success("Suspension of classes saved successfully!");
        } catch (err) {
                                                    ...
                                                    <div className="relative mt-1 md:mt-0">
                                                        {field === "level" ? (
                                                            <select
                                                                ...
                                                                disabled={disabled}
                                                                className="w-full px-3 py-2 border border-slate-300 rounded-md shadow-sm focus:ring-2 focus:ring-blue-200 focus:border-blue-500 focus:outline-none transition pr-10 disabled:bg-slate-100 disabled:cursor-not-allowed"
                                                            >
