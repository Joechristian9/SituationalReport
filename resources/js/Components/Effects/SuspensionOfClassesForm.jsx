                                                    ...
                                                    <div className="relative mt-1 md:mt-0">
                                                        {field === "level" ? (
                                                            <select
                                                                ...
                                                                className="w-full px-3 py-2 border border-slate-300 rounded-md shadow-sm focus:ring-2 focus:ring-blue-200 focus:border-blue-500 focus:outline-none transition pr-10"
                                                            >
                    ...
                    >
                        {isSaving ? (
                            ...
                            <>
                                ...
                                <span>Save Suspension of Classes</span>
                            </>
                        )}
                    </button>
                </div>
