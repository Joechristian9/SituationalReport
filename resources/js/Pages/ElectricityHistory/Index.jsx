...
export default function ElectricityHistoryIndex() {
        ...
        return (
            <>
                ...
                <TableCell className="max-w-xs">
                    <div className="truncate text-gray-700" title={report.barangays_affected}>
                        {report.barangays_affected || <span className="text-gray-400">-</span>}
                    </div>
                </TableCell>
                <TableCell className="max-w-xs">
    ...
    return (
        <ServiceHistoryPage
            ...
            title="Electricity Report History"
            icon={Zap}
            apiEndpoint="/api/electricity-history"
            breadcrumbLabel="Electricity Reports"
            columns={columns}
