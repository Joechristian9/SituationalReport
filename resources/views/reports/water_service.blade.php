...
<head>
    ...
    <title>Water Service Report - {{ $typhoon->name }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="section-title">WATER SERVICE REPORTS</div>
    
    <p class="timestamp">Source: IWD, BDRRMC</p>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th style="width: 20%;">Source of Water</th>
                <th style="width: 25%;">Barangays Served</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $report->source_of_water ?: '-' }}</td>
                <td>{{ $report->barangays_served ?: '-' }}</td>
            ...
            <tr>
                <td colspan="6" style="text-align: center; padding: 30px; color: #888;">
                    No water service reports available for this disaster.
                </td>
            </tr>
            @endforelse
        </tbody>
