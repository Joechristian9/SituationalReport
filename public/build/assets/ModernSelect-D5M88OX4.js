import{b as o,j as t}from"./index-IIQgGma6.js";import{a as b,C as h}from"./history-Cxfb007y.js";function v({value:s,onChange:d,options:u=[],placeholder:c="Select an option",icon:l=null,className:m=""}){const[r,a]=o.useState(!1),n=o.useRef(null);o.useEffect(()=>{const e=x=>{n.current&&!n.current.contains(x.target)&&a(!1)};return document.addEventListener("mousedown",e),()=>document.removeEventListener("mousedown",e)},[]);const i=u.find(e=>e.value===s),f=i?i.label:c;return t.jsxs("div",{className:`relative ${m}`,ref:n,children:[t.jsxs("button",{onClick:()=>a(!r),className:`
